...
surface.CreateFont("UCH_KillFont", {font = "AlphaFridgeMagnets ", size = ScreenScale(18), weight = 500, antialias = true, additive = false});

local KillNotices = {};
local mats = {};

mats["suicide"] = surface.GetTextureID("uch/killicons/suicide");
mats["bite"] = surface.GetTextureID("uch/killicons/bite");
mats["press"] = surface.GetTextureID("uch/killicons/press");
